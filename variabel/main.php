			...
			<div class="sticky">
				<aside class="app-sidebar sidebar-scroll">
					...
					<div class="main-sidemenu">
						<div class="main-sidebar-loggedin">
							<div class="app-sidebar__user">
								<div class="dropdown user-pro-body text-center">
									<div class="user-pic">
										<img src="aku.jpg" alt="user-img" class="rounded-circle mCS_img_loaded">
									</div>
									<div class="user-info">
										<h6 class=" mb-0 text-dark">saniah</h6>
										<span class="text-muted app-sidebar__user-name text-sm">XI software engineering</span>
									</div>
								</div>
							</div>
						</div>
						...
						<ul class="side-menu ">
							<li class="slide">
								<a class="side-menu__item" href="dasboard.html"><i class="side-menu__icon fe fe-airplay"></i><span class="side-menu__label">Dashboard</span></a>
							</li>
							<!-- <li class="slide">
								<a class="side-menu__item" data-bs-toggle="slide"   href="jenis buku.html"><i class="side-menu__icon fe fe-box"></i><span class="side-menu__label">jenis buku</span><i class="angle fe fe-chevron-down"></i></a>
								</ul>
							</li> -->
			...
			<div class="main-content app-content">
				...
				<div class="main-container d-flex">
					...
					<div class="row mx-auto">
						<div class="col-12 mt-4 col-mb-4">
							<div class="card bg-white bd-teal bd-4 rounded-30 ">
								<div class="item7-card">
									<a href="javascript:void(0);"></a>
									<img src="" alt="" height="50" class="cover-image rounded-7 w-auto">
								</div>
 <style>
    body{
    ...
    <table border="2" style="text-align: center; vertical-align: center;">
            ...
            <tr>
                ...
                <td>RPL</td>
                                     ...
                                     <div class="">
					                 <a href="javascript:void(0);" class="mt-4"><h5 class="font-weight-semibold text-dark"></h5></a>
					                <p class=""></p>
					                <p class="mb-0"></p>
                                    <center>
<?php //variabel adalah tempat menyimpan nilai sementara|sabiah XI-rpl
$txt = "jajan";
echo "I love $txt!";
?>
</center>
